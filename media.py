...
class Series(Video):
    """Series: defines properties for a movie series
    
    expected arguments: 3
        movie_title -- Title of series [text]
        count_seasons -- amount of seasons [integer]
        movie_storyline -- short series description [text]
    ...
    Functions: -/-
    """
    def __init__(self, movie_title, count_seasons, movie_storyline):
        Video.__init__(self, movie_title, movie_storyline)
        self.count_seasons = count_seasons